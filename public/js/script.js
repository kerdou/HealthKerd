...
if (document.body.contains(document.getElementById('docForm'))) {
  ...
  document.getElementById("lastname").addEventListener("focusout", focusOutRecheck);
  document.getElementById("firstname").addEventListener("focusout", focusOutRecheck);
  ...
  document.getElementById("webpage").addEventListener("focusout", focusOutRecheck);
  document.getElementById("doctolibpage").addEventListener("focusout", focusOutRecheck);
}
...
function formChecks(target = 'all') {
  ...
  let nameBeginning = "^([a-zàáâäçèéêëìíîïñòóôöùúûü]+(( |')[a-zàáâäçèéêëìíîïñòóôöùúûü]+)*)+";
    ...
    *      [a-zàáâäçèéêëìíîïñòóôöùúûü]+(                                  )*       Doit contenir au moins 1 des éléments de la liste et doit être suivi de 0 ou plusieurs éléments de la liste suivante
    *                                   ( |')[a-zàáâäçèéêëìíîïñòóôöùúûü]+          Doit être suivi d'un espace ou d'un ' puis suivi d'au moins 1 des éléments de la liste */
  let nameEnding = "([-]([a-zàáâäçèéêëìíîïñòóôöùúûü]+(( |')[a-zàáâäçèéêëìíîïñòóôöùúûü]+)*)+)*$";
