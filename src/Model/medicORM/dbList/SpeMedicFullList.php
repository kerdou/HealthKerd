...
class SpeMedicFullList
{
     ...
     */
    public function stmtSelectDistinctForAttendedDocsOnEvent(string $whereString)
    {
        $stmtStart = '
            SELECT DISTINCT
                doc_list.docID,
     ...
     * @return string               Déclaration SQL complète
     */
    public function stmtSelectDistinctForReplacedDocsOnEvent(string $whereString)
    {
        $stmtStart = '
            SELECT DISTINCT
     ...
     * @return string               Déclaration SQL complète
     */
    public function stmtSelectDistinctForLaboOrdoDocsOnEvent(string $whereString)
    {
        $stmtStart = '
            SELECT DISTINCT
     ...
     * @return string               Déclaration SQL complète
     */
    public function stmtSelectDistinctForReplacedLaboOrdoDocsOnEvent(string $whereString)
    {
        $stmtStart = '
            SELECT DISTINCT
